...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            lastVertex = new GraphDB.Vertex(attributes.getValue("id"),
                    attributes.getValue("lat"), attributes.getValue("lon"));
            g.addVertex(lastVertex);

        } else if (qName.equals("way")) {
            /* We encountered a new <way...> tag. */
            activeState = "way";
            lastEdge = new GraphDB.Edge(attributes.getValue("id"));
            ...
            /* Hint2: Not all ways are valid. So, directly connecting the vertices here would be
